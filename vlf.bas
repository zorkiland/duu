...
'read monster
	for i=0 to {var:anzahl_monster}-1
		...
		read {var:monster_tile}(i),{var:monster_atk}(i),{var:monster_def}(i),{var:monster_res}(i),{var:monster_exp}(i)
	next
'read player
	for i=0 to 3
		read {var:player_name}(i),{var:player_hp}(i),{var:player_mp}(i),{var:player_str}(i)
		read {var:player_tile}(i),{var:player_atk}(i),{var:player_def}(i),{var:player_waffe}(i),{var:player_ruestung}(i)
	next
...
{:mainloop_print_playertile}
	rem print"{home}"left$(cd$,3+y*2)spc(x*2){var:player_tile}(0);
	print"{home}"left$(cd$,3+y*2)spc(x*2)pm$;
{:mainloop_oldpos}
	ox=zx:oy=zy
	zx=x:zy=y
...
'monster
	'{var:monster_xxx}(x)
	'    name hp mp str tile atk def res exp
	data"imp",5,,8,"{lt. green}{$cd}{$ce}{down}{left:2}{$cf}{$d0}",4,1,,3
	data"snake",8,,12,"{gray3}{$d8}{$d9}{down}{left:2}{$da}{$db}",6,1,,5
	data"viper",12,,18,"{gray1}{$d8}{$d9}{down}{left:2}{$da}{$db}",6,1,,9
	data"nacho",30,,22,"{lt. red}{$cd}{$ce}{down}{left:2}{$cb}{$cc}",15,5,,50
	data"golem",20,,4,"{gray2}{$af}{$b0}{down}{left:2}{$b1}{$b2}",20,8,,17
	data"moss",30,,7,"{lt. green}{$af}{$b0}{down}{left:2}{$b1}{$b2}",26,9,,21
	data"bones",50,,20,"{brown}{$b3}{$b4}{down}{left:2}{$b5}{$b6}",18,8,,15
	data"wisp",25,50,15,"{green}{$bb}{$bc}{down}{left:2}{lt. green}{$bd}{$be}",,8,,17
	data"troll",100,,9,"{gray3}{$af}{$b0}{down}{left:2}{$b1}{$b2}",40,13,,100
	data"spark",30,50,22,"{yellow}{$bb}{$bc}{down}{left:2}{gray3}{$bd}{$be}",,8,,17
	data"burner",80,90,30,"{gray3}{$b3}{$b4}{down}{left:2}{$b5}{$b6}",25,13,,42
	data"tberry",120,10,60,"{lt. green}{$b3}{$b4}{down}{left:2}{$b5}{$b6}",60,20,,150
	data"dracul",250,60,50,"{gray2}{rvrs on}de{down}{left:2}fg{rvrs off}",70,25,,500
	data"glados",500,70,60,"{gray2}{rvrs on}hi{down}{left:2}jk{rvrs off}",80,30,,1000
'player
	'{var:player_xxx}(x)
	'    name hp mp str tile atk def waffe ruestung
	data"kron",15,,10,"{lt. red}{$c9}{$ca}{down}{left:2}{$cb}{$cc}",4,3,,  'tk
	data"lena",17,,10,"{gray2}{rvrs on}${rvrs off}{$ca}{down}{left:2}{$cb}{$cc}",3,3,,    'vi
	data"dolm",9,7,8,"{lt. green}{$c9}{$ca}{down}{left:2}{$cb}{$cc}",1,1,, 'gn
	data"mira",9,23,7,"{orange}{rvrs on}${rvrs off}{$ca}{down}{left:2}{$cb}{$cc}",1,1,1,2 'bl
'tile
	'{var:map_tile}(x)
data"{gray1}{rvrs off}{200}{rvrs off}{gray1}{201}{down}{left:2}{rvrs off}{gray1}{201}{rvrs off}{gray1}{200}{rvrs off}"
data"{gray1}{rvrs off}{202}{rvrs off}{gray1}{203}{down}{left:2}{rvrs off}{gray1}{200}{rvrs off}{gray1}{201}{rvrs off}"
data"{gray1}{rvrs off}{204}{rvrs off}{gray1}{205}{down}{left:2}{rvrs off}{gray1}{200}{rvrs off}{gray1}{201}{rvrs off}"
data"{orange}{rvrs off}{206}{rvrs off}{orange}{206}{down}{left:2}{rvrs off}{orange}{206}{rvrs off}{orange}{206}{rvrs off}"
data"{gray1}{rvrs off}{200}{rvrs off}{gray1}{201}{down}{left:2}{rvrs off}{gray1}{201}{rvrs off}{gray1}{200}{rvrs off}"
data"{gray1}{rvrs off}{207}{rvrs off}{gray1}{208}{down}{left:2}{rvrs off}{gray1}{209}{rvrs off}{gray1}{210}{rvrs off}"
data"{lt. green}{rvrs off}{211}{rvrs off}{lt. green}{206}{down}{left:2}{rvrs off}{lt. green}{206}{rvrs off}{lt. green}{212}{rvrs off}"
data"{gray1}{rvrs off}{213}{rvrs off}{gray1}{214}{down}{left:2}{rvrs off}{gray1}{215}{rvrs off}{gray1}{216}{rvrs off}"
data"{brown}{rvrs off}{217}{rvrs off}{brown}{218}{down}{left:2}{rvrs off}{brown}{219}{rvrs off}{brown}{220}{rvrs off}"
data"{lt. red}{rvrs off}{221}{rvrs off}{lt. red}{221}{down}{left:2}{rvrs off}{lt. red}{221}{rvrs off}{lt. red}{221}{rvrs off}"
data"{lt. red}{rvrs off}{222}{rvrs off}{lt. red}{223}{down}{left:2}{rvrs off}{lt. red}{161}{rvrs off}{lt. red}{162}{rvrs off}"
data"{lt. red}{rvrs off}{163}{rvrs off}{lt. red}{164}{down}{left:2}{rvrs off}{lt. red}{165}{rvrs off}{lt. red}{166}{rvrs off}"
data"{lt. green}{rvrs off}{211}{rvrs off}{lt. green}{206}{down}{left:2}{rvrs off}{lt. green}{206}{rvrs off}{lt. green}{212}{rvrs off}"
data"{brown}{rvrs off}{167}{rvrs off}{brown}{167}{down}{left:2}{rvrs off}{brown}{167}{rvrs off}{brown}{167}{rvrs off}"
data"{brown}{rvrs off}{168}{rvrs off}{brown}{168}{down}{left:2}{rvrs off}{brown}{168}{rvrs off}{brown}{168}{rvrs off}"
data"{gray2}{rvrs off}{169}{rvrs off}{gray2}{170}{down}{left:2}{rvrs off}{gray2}{171}{rvrs off}{gray2}{172}{rvrs off}"
data"{gray1}{rvrs off}{173}{rvrs off}{gray1}{174}{down}{left:2}{rvrs off}{gray1}{175}{rvrs off}{gray1}{176}{rvrs off}"
data"{lt. green}{rvrs off}{177}{rvrs off}{lt. green}{178}{down}{left:2}{rvrs off}{lt. green}{179}{rvrs off}{lt. green}{180}{rvrs off}"
data"{lt. green}{rvrs off}{181}{rvrs off}{lt. green}{182}{down}{left:2}{rvrs off}{lt. green}{181}{rvrs off}{lt. green}{182}{rvrs off}"
data"{lt. green}{rvrs off}{183}{rvrs off}{lt. green}{184}{down}{left:2}{rvrs off}{lt. green}{185}{rvrs off}{lt. green}{186}{rvrs off}"
data"{brown}{rvrs off}{177}{rvrs off}{brown}{178}{down}{left:2}{rvrs off}{brown}{179}{rvrs off}{brown}{180}{rvrs off}"
data"{brown}{rvrs off}{181}{rvrs off}{brown}{182}{down}{left:2}{rvrs off}{brown}{181}{rvrs off}{brown}{182}{rvrs off}"
data"{brown}{rvrs off}{183}{rvrs off}{brown}{184}{down}{left:2}{rvrs off}{brown}{185}{rvrs off}{brown}{186}{rvrs off}"
data"{brown}{rvrs off}{211}{rvrs off}{brown}{206}{down}{left:2}{rvrs off}{brown}{206}{rvrs off}{brown}{212}{rvrs off}"
data"{brown}{rvrs off}{187}{rvrs off}{brown}{187}{down}{left:2}{rvrs off}{brown}{188}{rvrs off}{brown}{188}{rvrs off}"
data"{gray1}{rvrs off}{189}{rvrs off}{gray1}{190}{down}{left:2}{rvrs off}{gray1}{191}{rvrs on}{gray1}{64}{rvrs off}"
data"{brown}{rvrs off}{187}{rvrs on}{brown}{65}{down}{left:2}{rvrs off}{brown}{188}{rvrs off}{brown}{188}{rvrs off}"
data"{brown}{rvrs on}{65}{rvrs off}{brown}{187}{down}{left:2}{rvrs off}{brown}{188}{rvrs off}{brown}{188}{rvrs off}"
data"{gray1}{rvrs off}{206}{rvrs off}{gray1}{206}{down}{left:2}{rvrs off}{gray1}{206}{rvrs off}{gray1}{206}{rvrs off}"
data"{gray1}{rvrs on}{66}{rvrs off}{gray1}{206}{down}{left:2}{rvrs on}{gray1}{66}{rvrs off}{gray1}{206}{rvrs off}"
data"{gray1}{rvrs on}{66}{rvrs off}{gray1}{206}{down}{left:2}{rvrs on}{gray1}{67}{rvrs off}{gray1}{206}{rvrs off}"
data"{gray1}{rvrs on}{68}{rvrs on}{gray1}{69}{down}{left:2}{rvrs on}{gray1}{70}{rvrs on}{gray1}{70}{rvrs off}"
data"{gray1}{rvrs on}{71}{rvrs on}{gray1}{71}{down}{left:2}{rvrs on}{gray1}{72}{rvrs on}{gray1}{72}{rvrs off}"
...
data"{gray1}{rvrs off}{32}{rvrs off}{gray1}{32}{down}{left:2}{rvrs off}{gray1}{32}{rvrs off}{gray1}{32}{rvrs off}"
data"{gray1}{rvrs off}{32}{rvrs off}{gray1}{32}{down}{left:2}{rvrs off}{gray1}{32}{rvrs off}{gray1}{32}{rvrs off}"
data"{orange}{rvrs on}{73}{rvrs on}{orange}{74}{down}{left:2}{rvrs on}{orange}{75}{rvrs on}{orange}{76}{rvrs off}"
data"{gray1}{rvrs on}{77}{rvrs on}{gray1}{74}{down}{left:2}{rvrs on}{gray1}{75}{rvrs on}{gray1}{76}{rvrs off}"
data"{lt. green}{rvrs on}{78}{rvrs on}{lt. green}{79}{down}{left:2}{rvrs on}{lt. green}{80}{rvrs on}{lt. green}{81}{rvrs off}"
data"{gray2}{rvrs on}{82}{rvrs on}{gray2}{83}{down}{left:2}{rvrs on}{gray2}{84}{rvrs on}{gray2}{85}{rvrs off}"
data"{gray1}{rvrs on}{86}{rvrs on}{gray1}{87}{down}{left:2}{rvrs on}{gray1}{88}{rvrs on}{gray1}{89}{rvrs off}"
data"{gray1}{rvrs on}{90}{rvrs on}{gray1}{91}{down}{left:2}{rvrs on}{gray1}{92}{rvrs on}{gray1}{93}{rvrs off}"
data"{gray1}{rvrs off}{32}{rvrs off}{gray1}{32}{down}{left:2}{rvrs off}{gray1}{32}{rvrs off}{gray1}{32}{rvrs off}"
data"{gray1}{rvrs off}{32}{rvrs off}{gray1}{32}{down}{left:2}{rvrs off}{gray1}{32}{rvrs off}{gray1}{32}{rvrs off}"
...
data"{gray1}{rvrs off}{32}{rvrs off}{gray1}{32}{down}{left:2}{rvrs off}{gray1}{32}{rvrs off}{gray1}{32}{rvrs off}"
data"{gray1}{rvrs off}{32}{rvrs off}{gray1}{32}{down}{left:2}{rvrs off}{gray1}{32}{rvrs off}{gray1}{32}{rvrs off}"
data"{lt. green}{rvrs on}{94}{rvrs on}{lt. green}{95}{down}{left:2}{rvrs on}{lt. green}{33}{rvrs on}{lt. green}{35}{rvrs off}"
data"{gray3}{rvrs on}{36}{rvrs on}{gray3}{37}{down}{left:2}{rvrs on}{gray3}{38}{rvrs on}{gray3}{39}{rvrs off}"
data"{gray1}{rvrs on}{36}{rvrs on}{gray1}{37}{down}{left:2}{rvrs on}{gray1}{38}{rvrs on}{gray1}{39}{rvrs off}"
data"{lt. green}{rvrs on}{40}{rvrs on}{lt. green}{41}{down}{left:2}{rvrs on}{lt. green}{42}{rvrs on}{lt. green}{43}{rvrs off}"
data"{gray1}{rvrs on}{44}{rvrs on}{gray1}{45}{down}{left:2}{rvrs on}{gray1}{46}{rvrs on}{gray1}{47}{rvrs off}"
data"{gray1}{rvrs on}{48}{rvrs on}{gray1}{49}{down}{left:2}{rvrs on}{gray1}{50}{rvrs on}{gray1}{51}{rvrs off}"
data"{gray1}{rvrs on}{52}{rvrs on}{gray1}{53}{down}{left:2}{rvrs on}{gray1}{54}{rvrs on}{gray1}{55}{rvrs off}"
data"{gray1}{rvrs on}{56}{rvrs on}{gray1}{57}{down}{left:2}{rvrs on}{gray1}{58}{rvrs on}{gray1}{59}{rvrs off}"
data"{lt. green}{rvrs on}{60}{rvrs on}{lt. green}{61}{down}{left:2}{rvrs on}{lt. green}{62}{rvrs on}{lt. green}{63}{rvrs off}"
data"{gray3}{rvrs on}{56}{rvrs on}{gray3}{57}{down}{left:2}{rvrs on}{gray3}{58}{rvrs on}{gray3}{59}{rvrs off}"
data"{gray1}{rvrs on}{52}{rvrs on}{gray1}{53}{down}{left:2}{rvrs on}{gray1}{54}{rvrs on}{gray1}{55}{rvrs off}"
data"{lt. green}{rvrs on}{52}{rvrs on}{lt. green}{53}{down}{left:2}{rvrs on}{lt. green}{54}{rvrs on}{lt. green}{55}{rvrs off}"
data"{gray1}{rvrs on}{192}{rvrs on}{gray1}{193}{down}{left:2}{rvrs on}{gray1}{194}{rvrs on}{gray1}{195}{rvrs off}"
data"{gray1}{rvrs on}{196}{rvrs on}{gray1}{197}{down}{left:2}{rvrs on}{gray1}{198}{rvrs on}{gray1}{199}{rvrs off}"
data"{gray1}{rvrs off}{32}{rvrs off}{gray1}{32}{down}{left:2}{rvrs off}{gray1}{32}{rvrs off}{gray1}{32}{rvrs off}"
data"{gray1}{rvrs off}{32}{rvrs off}{gray1}{32}{down}{left:2}{rvrs off}{gray1}{32}{rvrs off}{gray1}{32}{rvrs off}"
'items
